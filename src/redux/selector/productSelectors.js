export const getIsFechingSelectors = (state) => state.productReducers.isFetching;
export const getListCategorySelectors = (state) => state.productReducers.listCategory;
